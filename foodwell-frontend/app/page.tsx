...
export default function Home() {
  ...
  const processFile = async (file: File) => {
    ...
    setLoading(true); setUploadSuccess(false);
    await fetch(`${BASE_URL}/invoice/upload`, { method: "POST", body: formData });
    await fetchPantry();
    setLoading(false); setUploadSuccess(true);
  ...
  const generateMeals = async () => {
    ...
    } catch (err) { console.error("Meals generation failed:", err); }
          ...
          <div className="main-header">
            ...
            {activeTab !== "profile" && (
              <div className="header-actions">
                <button className="btn-primary" onClick={generateMeals} disabled={loading}>
